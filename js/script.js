(function($) { 
    ...
    if($('#gallery').length){
	 ...
	 function activeTabs(){
			$(".tab-images1").each(function(){
			var images = $(this).find("div");
			console.log("Length: " + images.length);
			if(images.length === 1) {
				console.log("In condition 1");
				$(".t-image1").addClass("cell-12");
			}   
			else if(images.length === 2) {
				console.log("In condition 2");
				$(".t-image1").addClass("cell-6");
				
			}
			else if(images.length === 3) {
				console.log("In condition 3");
				$(".t-image1").addClass("cell-4");
			
			}
			else {
				$(".t-image1").addClass("cell-3");
				
				console.log("In condition else");
			}
		});
		$(".tab-images2").each(function(){
			var images = $(this).find("div");
			console.log("Length: " + images.length);
			if(images.length === 1) {
				console.log("In condition 1");
				$(".t-image2").addClass("cell-12");
			}   
			else if(images.length === 2) {
				console.log("In condition 2");
				$(".t-image2").addClass("cell-6");
				
			}
			else if(images.length === 3) {
				console.log("In condition 3");
				$(".t-image2").addClass("cell-4");
				
			}
			else {
				$(".t-image2").addClass("cell-3");
				console.log("In condition else");
			}
		});
		}
		 ...
		 $(".menuList a ").each(function(){
			  if($(this).attr("href") === pgurl ){
				  if($(this).closest("li").hasClass("main")){
					  ...
					  $(".menuList").find("#products").addClass("selected");
					  $(this).closest("li").addClass("selected");
				  }
			  }
			 else{
